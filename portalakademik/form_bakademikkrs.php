...
switch($_GET['halaman']){
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <div class="bootstrap-admin-panel-content">                   
                <form method="post" action="?page=baakademikjadwalkrs&halaman=cari">
        ...
        <div class="col-lg-12">
          ...
          <body class="bootstrap-admin-with-small-navbar">
            ...
            echo"  <tr class='odd gradeX'>
                     ...
                     <td>$r->Nama</td>
                     <td>$label</td>                     
                     <td width=90><form method='post' action='?page=baakademikjadwalkrs&halaman=lihatkrs'>
  ...
  ?>
    <div class="col-md-10"> 
     ...
     echo"<form method='post' action='?page=baakademikjadwalkrs&halaman=tambahkrs'> 
          <table class='table table-striped' style='font-size:13px;''>
             <input name='Tahun_ID' type=hidden value='$_REQUEST[Tahun_ID]'>
             <input name='Angkatan' type=hidden value='$_REQUEST[Angkatan]'>
             <input name='NIM' type=hidden value='$r->NIM'>
        ...
        <form method='post' target=_new action='cetakkrs.php'> 
          ...
          <body class="bootstrap-admin-with-small-navbar">
            ...
            echo"  <tr class='odd gradeX'>
                     ...
                     <td width=90><form method='post' action='form_bakademikkrsact.php?page=baakademikjadwalkrs&halaman=hapuskrs'>
    ...
    <div class="col-md-10"> 
        <div class="col-lg-12">
          <div class="panel panel-primary">
            ...
            <?php 
     $query = $pdo->prepare("SELECT a.NIM,a.Nama,a.Identitas_ID,a.Jurusan_ID,a.Program_ID,a.Angkatan,a.StatusMhsw_ID,a.Kurikulum_ID,a.PenasehatAkademik,c.Nama AS status 
                         FROM mahasiswa a LEFT JOIN statusmhsw c ON a.StatusMhsw_ID=c.StatusMhsw_ID
                         WHERE  a.NIM='$_REQUEST[NIM]'");
     ...
     echo" <table class='table table-striped' style='font-size:13px;''>
            <tr><td><strong>NIM</strong></td><td><strong>: $_REQUEST[NIM] </strong></td><td><strong>Dosen Pembimbing</strong></td> <td><strong>: $r->PenasehatAkademik</strong></td></tr>         
            <tr><td><strong>Nama</strong></td><td><strong>: $r->Nama </strong></td><td><strong> Status Mahasiswa</strong></td> <td><strong>: $r->StatusMhsw_ID - $r->status</strong></td></tr>          
          </table>";
          echo"<form method='post' action='form_bakademikkrsact.php?page=baakademikjadwalkrs&halaman=simpankrs'>
