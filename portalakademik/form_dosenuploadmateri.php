...
switch($_GET['halaman']){
  ...
  ?>               
    ...
    <div class="col-md-10"> 
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <div class="text-muted bootstrap-admin-box-title" style="color:white;">Dosen | Upload File</div>
            </div>
     ...
     echo"<form method='post' action='?page=1f56234e-4361-4706-bb5a-91d3101bbdb6&halaman=share'> 
          ...
          <body class="bootstrap-admin-with-small-navbar">
            ...
            $sql = $pdo->prepare("select * from fileupload where Level_ID='2' and Uplouder='$_SESSION[username]'");
            $sql->execute();
            ...
            echo"  <tr class='odd gradeX'>
                     <td width=10>$no</td>
                      <td width=90><form method='post' action='form_dosenuploadmateriact.php?page=1f56234e-4361-4706-bb5a-91d3101bbdb6&halaman=hapus'>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <div class="bootstrap-admin-panel-content">                   
                ...
                <form method="post" id="selecttest" action="form_dosenuploadmateriact.php?page=1f56234e-4361-4706-bb5a-91d3101bbdb6&halaman=simpan" enctype="multipart/form-data">
                  <table class="table table-striped" style="font-size:13px;">
                  <?php  
